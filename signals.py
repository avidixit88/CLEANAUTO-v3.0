...
def compute_scalp_signal(
    ...
    *,
    ...
    if tape_mode_enabled:
        ...
        effective_readiness_long = float(tape_long.get("readiness") or 0.0) + 0.75 * float(tape_reversal_long.get("bonus") or 0.0)
        effective_readiness_short = float(tape_short.get("readiness") or 0.0) + 0.75 * float(tape_reversal_short.get("bonus") or 0.0)
        ...
        tape_pre_long_assist = bool(
            ...
            and (not vwap_event)
            and (
                effective_readiness_long >= 6.0
                or (
                    effective_readiness_long >= 5.5
        ...
        tape_pre_short_assist = bool(
            ...
            and (not vwap_event)
            and (
                effective_readiness_short >= 6.0
                or (
                    effective_readiness_short >= 5.5
        ...
        if actionable_local:
            ...
            if tape_mode_enabled:
                ...
                combined_rejection_penalty_local = float(max(
                    ...
                    1.0 if bool(breakout_acceptance_quality_local.get("rejection") or False) else 0.0,
                ))
                tape_breakout_ready_local = bool(
                    ...
                    and not stale_breakout_local
                    and combined_rejection_penalty_local <= 0.5
                )
                ...
                if combined_rejection_penalty_local > 0.0:
                    breakout_bias_score_local -= (2 if combined_rejection_penalty_local >= 1.0 else 1)
                ...
                tape_prefers_breakout_local = bool(
                    ...
                    and combined_rejection_penalty_local < 1.0
                )
            ...
            if breakout_bias and bool(breakout_acceptance_quality_local.get("rejection") or False):
                breakout_bias = False
            if not breakout_bias:
                breakout_bias = bool(
                    ...
                    and not bool(breakout_acceptance_quality_local.get("rejection") or False)
                )
            if not breakout_bias and tape_prefers_breakout_local and near_break_local and (near_pullback_local or breakout_bias_score_local >= 4) and not bool(breakout_acceptance_quality_local.get("rejection") or False):
                breakout_bias = True
